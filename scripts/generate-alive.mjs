/**
 * Generate assets/alive.svg — 猫猫鸡存活时间
 * Birth: 2026-07-20 18:30:00 Asia/Shanghai (UTC+8)
 */
...
const BIRTH_MS = Date.parse("2026-07-20T18:30:00+08:00");
const __dirname = dirname(fileURLToPath(import.meta.url));
const OUT = join(__dirname, "..", "assets", "alive.svg");
...
const age = split(Date.now() - BIRTH_MS);
const label = `${age.days} 天 ${pad(age.hours)} 时 ${pad(age.minutes)} 分 ${pad(age.seconds)} 秒`;

const svg = `<?xml version="1.0" encoding="UTF-8"?>
<svg xmlns="http://www.w3.org/2000/svg" width="640" height="160" viewBox="0 0 640 160" role="img" aria-label="${escapeXml(label)}">
  <defs>
  ...
  <g font-family="ui-monospace, Cascadia Code, Consolas, monospace" font-weight="700">
    <g transform="translate(32,78)">
      ...
      <text x="60" y="38" text-anchor="middle" font-size="30" fill="#EA580C">${age.days}</text>
    ...
    <g transform="translate(168,78)">
      ...
      <text x="50" y="38" text-anchor="middle" font-size="30" fill="#EA580C">${pad(age.hours)}</text>
    ...
    <g transform="translate(284,78)">
      <rect width="100" height="64" rx="12" fill="#FFFFFF" stroke="#FDBA74"/>
      <text x="50" y="38" text-anchor="middle" font-size="30" fill="#EA580C">${pad(age.minutes)}</text>
    ...
    <g transform="translate(400,78)">
      <rect width="100" height="64" rx="12" fill="#FFFFFF" stroke="#FDBA74"/>
      <text x="50" y="38" text-anchor="middle" font-size="30" fill="#EA580C">${pad(age.seconds)}</text>
